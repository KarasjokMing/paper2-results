...
Therefore, $T_2$ and $T_3$ are used as representative members of these two pairs, while $R_2$ and $R_3$ are retained in the full numerical data set and in the repository all-target figure but not shown in the main figure.
...
The compact $T_2$ island in Fig.~\ref{fig:phase_maps}, together with its symmetry-related $R_2$ counterpart retained in the full numerical data set, becomes more transparent when the correlated phase branch behind the composite-interference route is imposed explicitly.
