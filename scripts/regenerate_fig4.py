...
PARAM_PATH = ROOT / "data" / "optimized_params.json"
...
def main() -> None:
    ...
    fig.tight_layout()
    fig.savefig(OUT_DIR / "fig4_detuning_sensitivity.pdf")
    fig.savefig(OUT_DIR / "fig4_detuning_sensitivity.png")
    print(f"Wrote {OUT_DIR / 'fig4_detuning_sensitivity.pdf'}")
